...
# OmniSmith (The OmniRhythm Engine)

**OmniSmith** is the evolution of two separate music projects: the **Openthesia** MIDI visualization software, and the **Slopsmith** Rocksmith CDLC guitar highway player. 
The current development plan aims to unify these applications into the **OmniRhythm Engine**, an architecture designed to parse both MIDI tracks and `.psarc` audio packages alongside a polymorphic 2D/3D perspective GUI.
...
### Legacy Openthesia Documentation
