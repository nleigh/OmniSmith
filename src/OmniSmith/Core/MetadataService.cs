...
public static class MetadataService
{
    ...
    private static readonly string _cacheDir = Path.Combine(KnownFolders.RoamingAppData.Path, "OmniSmith", "Cache", "Thumbnails");
    ...
    {
        _httpClient.DefaultRequestHeaders.Add("User-Agent", "OmniSmith/1.0");
