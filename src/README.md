...
# OmniSmith [![Github All Releases](https://img.shields.io/github/v/release/ImAxel0/OmniSmith?&style=for-the-badge)]() [![Github All Releases](https://img.shields.io/github/downloads/ImAxel0/OmniSmith/total.svg?&color=31CB15&style=for-the-badge)]()
...
:orange_book: [Documentation](https://OmniSmith.pages.dev/documentation) :orange_book:

## What can it do :question:

OmniSmith includes two main modes, **Midi playback** and **Play mode**.
...
- **Plugins support**: use your favorite VST2 instruments and audio effects directly inside OmniSmith!
...
OmniSmith is officially supported on **Windows**.
...
Download the latest setup from the [releases](https://github.com/ImAxel0/OmniSmith/releases) section and install the program.
...
![OmniSmith_home](https://github.com/ImAxel0/OmniSmith/assets/124681710/bf9d0fc8-55a9-4583-9514-da29bd5159dd)

![playback](https://github.com/ImAxel0/OmniSmith/assets/124681710/bfccfaac-cb8f-4ffc-87ac-23c0ced6b0e8)

![OmniSmith_playmode](https://github.com/ImAxel0/OmniSmith/assets/124681710/915717df-796a-4697-904a-8582321f3de6)

![OmniSmith_settings](https://github.com/ImAxel0/OmniSmith/assets/124681710/7e8afe03-764c-4ff1-af9d-2337b03edd23)
